...
PROVIDER_PRESETS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "notes": "Free access to many open models (40 req/min). Requires phone verification. Exclusive Nemotron + DeepSeek V4 models.",
    },
    {
        "key": "sambanova",
        ...
        "notes": "Record-fast inference on RDU hardware. $5 trial credits for 3 months, then pay-per-token (very cheap). Best latency for sniper entries.",
    },
    {
        "key": "cohere",
        "label": "Cohere",
    ...
    },
    {
        ...
        "notes": "Free with a GitHub personal access token (paste it as the API key). Access to GPT-4o, o3-mini, DeepSeek-R1. Tight per-request token limits — use for lightweight checks.",
    },
    {
        "key": "fireworks",
        "label": "Fireworks AI",
        ...
        "notes": "Fast open-weight serving. $1 signup credit, then cheap pay-per-token. Model ids use the 'accounts/fireworks/models/...' prefix.",
    },
    {
        "key": "openai",
        "label": "OpenAI",
