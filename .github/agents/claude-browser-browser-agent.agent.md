...
name: "Claude browser-agent (browser/browser-agent)"
tools: [execute, read, edit, search, agent, web, todo]
argument-hint: "Describe the task for this Claude-derived agent"
---

<!-- Generated by scripts/sync_claude_to_copilot.py from .claude/agents/browser/browser-agent.yaml. Edit the Claude source and rerun the sync. -->

# browser-agent

This GitHub Copilot agent was generated from a Claude YAML agent definition.

- Source: `.claude/agents/browser/browser-agent.yaml`
- Original format: `.yaml`
- Summary: Web automation specialist using agent-browser with AI-optimized snapshots
