...
name: "Claude flow-nexus-neural (flow-nexus/neural-network)"
tools: [execute, read, edit, search, agent, web, todo]
argument-hint: "Describe the task for this Claude-derived agent"
---

<!-- Generated by scripts/sync_claude_to_copilot.py from .claude/agents/flow-nexus/neural-network.md. Edit the Claude source and rerun the sync. -->
