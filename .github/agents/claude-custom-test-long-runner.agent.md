...
name: "Claude test-long-runner (custom/test-long-runner)"
tools: [execute, read, edit, search, agent, web, todo]
argument-hint: "Describe the task for this Claude-derived agent"
---

<!-- Generated by scripts/sync_claude_to_copilot.py from .claude/agents/custom/test-long-runner.md. Edit the Claude source and rerun the sync. -->
