...
name: "Claude matrix-optimizer (sublinear/matrix-optimizer)"
tools: [execute, read, edit, search, agent, web, todo]
argument-hint: "Describe the task for this Claude-derived agent"
---

<!-- Generated by scripts/sync_claude_to_copilot.py from .claude/agents/sublinear/matrix-optimizer.md. Edit the Claude source and rerun the sync. -->
