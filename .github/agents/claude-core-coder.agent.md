...
tools: [vscode, execute, read, agent, HidenobuNagai.nvidia-nim-provider, ms-python.python, edit, search, web, browser, 'headroom/*', mcp-server/search, azure-mcp/search, 'lean-ctx/*', todo]
