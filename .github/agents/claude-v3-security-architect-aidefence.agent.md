---
description: "Claude-derived agent mirrored from .claude/agents/v3/security-architect-aidefence.md"
name: "Claude security-architect-aidefence (v3/security-architect-aidefence)"
tools: [execute, read, edit, search, agent, web, todo]
argument-hint: "Describe the task for this Claude-derived agent"
---

<!-- Generated by scripts/sync_claude_to_copilot.py from .claude/agents/v3/security-architect-aidefence.md. Edit the Claude source and rerun the sync. -->
